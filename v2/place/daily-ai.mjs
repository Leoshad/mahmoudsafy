...
export const morningKinds=['mature romance','suggestive, non-graphic adult flirting','an intelligent personal question','affectionate teasing','a small playful challenge','an original shared activity'];
