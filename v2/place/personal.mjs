...
export const FRAMES=[
 ['bad-mood','Bad Mood','☁','#9992c5'],['unwell','Feeling Unwell','🩹','#92cbb7'],['tired','Feeling Tired','▱','#91acd3'],['space','Need Some Space','☾','#b8a0db'],['busy','Overwhelmed & Busy','⌛','#d6a273'],['good','Good Mood','☁','#efcc79'],['birthday','Birthday Mode','🕯','#ed9ebd'],['women','Women’s Day','♀','#ce91d6'],['awareness','Breast Cancer Awareness','🎗︎','#ef8fb8'],['hug','Need a Hug','♥','#ef9cbc'],['miss','I Miss You','♥','#dba0db'],['upset','Upset With You','☹','#c685a3'],['by-your-side','Always by Your Side','🫶','#e2bc91'],['in-love','In Love','🥰','#ee9eba'],['sad','Feeling Sad','😔','#98adc9']
