...
export const buzzKinds={electric:['⚡','Buzz'],love:['❤️','Love'],kiss:['💋','Kiss'],angry:['😡','Grrr!'],need:['🔔','I need you'],sad:['😔','Feeling sad'],miss:['🥺','I miss you'],side:['💕','You’re not alone'],gzzzz:['😬','Gzzzz']};
