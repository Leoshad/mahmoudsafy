...
async function recoverConnection(immediate=false){
 ...
 if(immediate){
  ...
  if(state&&(recoverConnection.resumePending||(source?.readyState===1&&Date.now()-lastEvent>5000))){source?.close();source=null;paintPresence(false);}
