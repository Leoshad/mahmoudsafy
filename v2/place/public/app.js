...
function paintQuote(root,message){
 ...
 const text=el('span',null,root,'reply-copy');el('strong',message.author,text);el('span',message.text?.slice(0,140)||(message.image?'Photo':'Message'),text);
