...
Domino rollback: restored the exact original table sizing, tile scaling and stable path from 3a988ffc. Removed the minimum tile size and expanding table changes at the user's request. Fullscreen chat unread badges remain.
