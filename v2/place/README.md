...
### Shared touch
At the bottom of Our Chat, a direct upward swipe starting in the bottom quarter of blank message space and reaching its midpoint reveals one fingerprint over the unchanged chat. Reversing or releasing before the threshold stays local. Completion opens the shared overlay directly through authenticated SSE, with no invitation or notification. The partner sees it while the chat is visible and focused. A stationary 350 ms hold still owns the Balloon gesture; the direct swipe claims movement before 300 ms and cancels the balloon candidate. Neither overlay starts while the other owns the gesture.
