...
function fixture(){
 let timer;const calls=[];const c={mode:'idle',gesture:null,hold:null,progress:0,h:500,suppressUntil:0,blocked:'button',document:{querySelector:()=>null},setTimeout:f=>(timer=f,1),clearTimeout:()=>timer=null,unlock(){},open(){calls.push('open');c.mode='inflating';},close(){calls.push('close');c.mode='idle';},ready(){calls.push('ready');c.mode='ready';},performance:{now:()=>100},Math};
