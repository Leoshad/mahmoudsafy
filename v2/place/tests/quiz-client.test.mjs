...
function client(s){
 ...
 vm.createContext(context);vm.runInContext(source.slice(source.indexOf('function renderActivity('),source.indexOf('function paintDraft(')),context);context.renderActivity(context.state.activity,root);
